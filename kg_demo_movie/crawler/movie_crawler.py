...
api_key = '59ee0eff1f10e49c7a739639f9829763'
...
mysql_db = pymysql.connect(host="localhost", user="root", password="YAN12345", db="kg_demo_movie", use_unicode=True, charset="utf8mb4")
...
if __name__ == '__main__':
    crawled_person_id_set = set()  # 记录获取过的人物（创建集合）
    crawled_movie_id_set = set()  # 记录获取过的电影（创建集合）

    mysql_cursor.execute("SET FOREIGN_KEY_CHECKS = 0")  # 禁用外键约束，解决MySQL中设置了foreign key关联，造成无法更新或删除数据的问题
